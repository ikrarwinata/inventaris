            ...
            <form action="List_kondisi/create_action" method="post">
            	<div class="modal-body">
            		<div class="form-group row">
            			...
            			<div class="col-8">
            				<input type="text" name="bahan" id="bahan" maxlength="150" class="form-control" required="true">
            			</div>
            		</div>
            		<div class="form-group row">
            			<div class="col-4">
	            ...
	            <div class="modal-footer justify-content-between">
	            	<input type="hidden" name="id" id="idbahan" value="">
		...
		<div class="col-12">
			...
			<div class="card">
				<div class="card-header">
	              <h3 class="card-title">Daftar Bahan Asets</h3>
	            </div>
			                ...
			                <?php foreach ($bahan_data as $value): ?>
			                	<tr>
				                  ...
				                  <td>
				                  	...
				                  	|
				                  	<a href="Bahan_asets/delete/<?php echo $value->id ?>" title="Hapus data" onclick="return confirm('Anda yakin ingin menghapus data ini ?')"><i class="fa fa-trash text-danger"></i></a>
				                  </td>
				                </tr>
			                <?php endforeach ?>
			                </tbody>
