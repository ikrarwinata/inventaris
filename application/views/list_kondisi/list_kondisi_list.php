            ...
            <form action="List_kondisi/create_action" method="post">
            	<div class="modal-body">
            		<div class="form-group row">
            			...
            			<div class="col-8">
            				<input type="text" name="kondisi" id="kondisi" maxlength="150" class="form-control" required="true">
            			</div>
            		</div>
            		<div class="form-group row">
            			<div class="col-4">
	            ...
	            <div class="modal-footer justify-content-between">
	            	<input type="hidden" name="id" id="idkondisi" value="">
		...
		<div class="col-12">
			...
			<div class="card">
				<div class="card-header">
	              <h3 class="card-title">Daftar Kondisi Asets</h3>
	            </div>
		              	...
		              	<table id="datatab1" class="table table-bordered table-striped">
			                ...
			                <?php foreach ($kondisi_data as $value): ?>
			                	<tr>
				                  ...
				                  <td><span class="kondisi-placeholder"><?php echo $value->kondisi ?></span></td>
				                  ...
				                  <td>
				                  	...
				                  	|
				                  	<a href="List_kondisi/delete/<?php echo $value->id ?>" title="Hapus data" onclick="return confirm('Anda yakin ingin menghapus data ini ?')"><i class="fa fa-trash text-danger"></i></a>
				                  </td>
				                </tr>
			                <?php endforeach ?>
			                </tbody>
